 ...
 * @LastEditTime: 2023-10-18 10:32:50
 * @LastEditors: caogd
 * @Description:工作流程条件
 */
 ...
 * 获取工作流条件类型
 */
export const getFlowConditionTypesComboApi = () => {
  return request({
    url: '/flow/flowcondition/getFlowConditionTypesCombo',
    method: 'get'
  })
}
/**
 * 获取工作流表名
 */
export const getConditionTableNameComboApi = () => {
  return request({
    url: '/flow/flowcondition/getConditionTableNameCombo',
    method: 'get'
  })
}
/**
...
export const getFlowConditionListApi = (data: string) => {
  return request({
    url: '/flow/flowcondition/getFlowConditionList',
    method: 'get',
