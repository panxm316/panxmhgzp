 ...
 * @LastEditTime: 2023-09-18 11:02:10
 * @LastEditors: peij
 * @Description: login
-->
<template>
  <div class="login">
    ...
    <el-form ref="loginRef" :model="loginForm" :rules="loginRules" class="login-form">
      <h3 class="title text-success">全媒体运营管理平台系统管理</h3>
...
const handleLogin = () => {
  proxy.$refs.loginRef.validate((valid: any) => {
    if (valid) {
      loading.value = true
      Cookies.set('Advertisingsys-UserName', loginForm.value.username, { expires: 30 })
      // 调用action的登录方法
      userStore
 ...
 */
const getCookie = () => {
  const username = Cookies.get('Advertisingsys-UserName')
