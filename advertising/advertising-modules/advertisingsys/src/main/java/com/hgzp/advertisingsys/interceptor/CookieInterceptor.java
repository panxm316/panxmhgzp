package com.hgzp.advertisingsys.interceptor;
...
public class CookieInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (url.contains("/captcha-image")
				|| url.contains("/login")
				|| url.contains("/logOut")
				|| url.contains("/otherSysLogin")
				|| url.contains("/noReferLogin")
				|| url.contains("/error")
				|| url.contains("/api")
				|| url.contains("/outapi")
				|| url.contains("/getmediacode")
				|| url.contains("/weibo/gettoken")
				|| url.contains("/fanwen")
				|| url.contains("/issueapi")
				|| url.contains("/resource")
				|| url.contains("/webhooks")
				|| url.contains("/callback")
				|| url.contains("/screenapi")
				|| url.contains("/hgmonitor")
				|| url.contains("/config")
				|| url.contains("/wordcount")
				|| url.contains("/innerapi")
				|| url.contains("/main/index")
				|| url.contains("/publicKey")
				|| url.contains("/apk")
