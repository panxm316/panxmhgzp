...
import static com.hgzp.common.flowable.constants.ProcessInstanceConstant.USER_TASK_NOBODY_HANDLER_TO_REFUSE;
...
public class NodeUtil {
    ...
    public static void handleApproveForm(Node node, List<FormItemVO> formItemVOList) {
        if (!com.hgzp.common.flowable.utils.NodeUtil.isNode(node)) {
            return;
        }
