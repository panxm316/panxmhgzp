...
public class LocalApi implements ApiStrategy, InitializingBean {
    ...
    @Resource
    private TwempholidaysServiceI twempholidaysService;
    @Resource
     ...
     */
    @Override
    public List<String> replaceHolidayUserId(List<String> userId){
        return twempholidaysService.replaceHolidayUser(userId);
    }
