...
public class CoreHttpUtil {
    ...
    public static R<List<String>> getProcessInstanceIdsByVar(String variableName, String variableValue) {
        String s =get("/process-instance/getProcessInstanceIdsByVar?variableName=" + variableName  + "&variableValue=" + variableValue);
