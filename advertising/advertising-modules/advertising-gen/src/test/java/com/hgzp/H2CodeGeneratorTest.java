...
public class H2CodeGeneratorTest extends BaseGeneratorTest {
    ...
    private static final String OUTPUT_DIR = System.getProperty("user.dir") + "/new-code-test";
    ...
    public void testSimple() {
        ...
        generator.global(globalConfig().outputDir(OUTPUT_DIR).build());
        generator.execute();
    }
    ...
    public void testDateType() {
        ...
        // 日期类型强制设置为 Date 类型
        generator.global(globalConfig().outputDir(OUTPUT_DIR).dateType(DateType.ONLY_DATE).build());
        generator.execute();
    }
