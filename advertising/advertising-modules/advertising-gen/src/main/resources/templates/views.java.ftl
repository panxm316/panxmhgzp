 ...
 * @Author: ${author}
 * @Date: ${date}
 * @Description: ${table.comment!} 前端视图页面
-->
<template>
  <div class="app-container">
    <div class="search_box">
      <div class="flex" style="width: 94%">
        ...
        <el-button type="success" icon="DocumentCopy" @click="handleAdd">合并</el-button>
        ...
        >
          <el-button
            ...
            :icon="!showSearch ? 'ArrowRightBold' : 'ArrowDownBold'"
            @click="toggleSearch()"
          />
        </el-tooltip>
    ...
    <div class="table_box">
      <el-row>
        ...
        >
          ...
          <el-table-column prop="icode" label="编码" sortable="custom" min-width="100">
          </el-table-column>
          ...
          <el-table-column prop="adindustryname" label="行业名称" sortable="custom" min-width="150">
          </el-table-column>
          <el-table-column prop="employname" label="主业务员" sortable="custom" min-width="150">
          </el-table-column>
          ...
          <el-table-column prop="scontacts" label="联系人" min-width="150"> </el-table-column>
          <el-table-column
          ...
          <el-table-column prop="sbrand" label="客户品牌" min-width="150"> </el-table-column>
          <el-table-column prop="sphone" label="办公电话" min-width="150"> </el-table-column>
          ...
          <el-table-column prop="screditcode" label="统一社会信用代码" min-width="180">
          </el-table-column>
          <el-table-column prop="sbankaccount" label="开户行及账号" min-width="180">
          </el-table-column>
          <el-table-column
            prop="parentName"
            label="父级名称"
          ...
          <el-table-column prop="bindividual" label="个人客户" width="100" align="center">
            <template #default="scope">
              <span v-if="!scope.row.bindividual"> 非个人客户 </span>
              <span v-if="scope.row.bindividual"> 个人客户 </span>
            </template>
          </el-table-column>
    ...
    >
      <el-form ref="CustomerFormRef" :model="CustomerData" label-width="150px" :rules="rules">
        ...
        <el-row
          v-if="
            detailshow === false && ShowCustomerbelong === true && CustomerData.iapprovestatus !== 1
          "
          :span="20"
        >
          <el-col>
            <el-form-item label="客户归属" prop="customerbelong">
              <Customer-Belong :customerid="CustomerBelongid"></Customer-Belong>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :span="20">
                ...
                <el-col :span="24">
                  <div v-for="(file, index) in CustomerData.customerfiles" :key="file.sfileid">
                    <el-link type="primary" :underline="false" @click="previewFile(file)">
                      <el-icon><Document /></el-icon> {{ file.soriginalfile }}
                    </el-link>
                    <el-button
                      link
                      type="danger"
...
const rules = reactive<FormRules<TAdCustomer>>({
  ...
  sphone: [
    { validator: validatePhone, required: true, message: '请输入正确的电话', trigger: 'change' },
...
const handleCancel = () => {
  ...
  dialogVisible.value = false
  setTimeout(() => {
    CustomerFormRef.value?.clearValidate(['sname', 'scontacts', 'saddress'])
  }, 10)
}
/**
 * 关闭附件弹窗
...
const previewFile = (file: Twcustomerfiles) => {
  ...
  if (file.sfiletype === 'Photo') {
    ...
    <#-- 以下语法在 FreeMarker 中冲突，需要在使用时手动放开注释 -->
...
const getCustomerCategory = () => {
  getcustomerCategoryComboApi().then(({ obj }: IAxios<TFlowType[]>) => {
    console.log(obj)
