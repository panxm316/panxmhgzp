 ...
 * @LastEditors: wanghl
 * @LastEditTime: 2024-03-12 10:38:45
 * @Description: 个人中心 - 我的客户
 *
-->
<template>
  <div class="app-container">
    ...
    <div class="table_box">
      ...
      >
        ...
        >
          <template #default="scope">
            <span v-if="scope.row.adindustryname">{{ scope.row.adindustryname }}</span>
            <span v-else>无</span>
          </template>
        </el-table-column>
        <el-table-column
...
import { computTableHeight, formatDate, formatMoney, tableHeaderColor } from '@/utils'
...
import CustomerWorkreports from '@/views/customer/CustomerWorkreports.vue'
/** 刊发状态列表 */
