<!--
 * @Author: songly
 * @Date: 2024-02-21 13:36:37
 * @LastEditTime: 2024-03-07 15:46:22
 * @LastEditors: wanghl
 * @Description:操作日志
-->
...
import { TOperatelog, TOperatelogQueryInfo } from '@/types/views/system/operatelog'
import { getOperatelogPageListApi } from '@/api/system/operatelog'
...
/** 日志列表 */
const sysoperatelogList = ref<TOperatelog[]>([])
/** 查询对象 */
const queryInfo = ref<TOperatelogQueryInfo>({
  sort: 'soperatetime',
  order: 'desc',
  queryKey: '',
  startTime: '',
 ...
 */
const loaddata = () => {
  const data: TOperatelogQueryInfo = queryInfo.value
  getOperatelogPageListApi(data).then(({ obj, total }: IAxios<TOperatelog[]>) => {
