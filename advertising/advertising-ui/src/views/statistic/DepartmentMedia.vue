    ...
    <div class="table_box">
     ...
     -->
      ...
      >
        ...
        <el-table-column prop="year" label="部门名称"></el-table-column>
        <el-table-column label="本月数" align="center">
          ...
          <el-table-column prop="monthHDTotal" label="多元化"></el-table-column>
          <el-table-column prop="monthTotal" label="本月合计"></el-table-column>
        </el-table-column>
        <el-table-column label="累计数" align="center">
          ...
          <el-table-column prop="yearHDTotal" label="多元化"></el-table-column>
...
import {
  exportAdvertisingDeptMediaApi,
  exportAdvertisingDeptMediaExcelApi
 ...
 */
const getReport = () => {
  exportAdvertisingDeptMediaApi().then((res: any) => {
    if (res.success) {
      console.log(res.obj)
