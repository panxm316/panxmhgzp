...
import {
  exportAreaIncomeCombinApi,
  exportAreaIncomeOpExcelApi
 ...
 */
const getReport = () => {
  exportAreaIncomeCombinApi().then((res) => {
    if (res.success) {
      console.log(res.obj)
...
const exportExcel = () => {
  exportAreaIncomeOpExcelApi({ reportFormId: '3' })
    .then((res: IAxios) => {
      console.log(res)
