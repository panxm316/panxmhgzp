    ...
    <div class="table_box">
     ...
     -->
      ...
      >
        ...
        <el-table-column label="经营公司" align="center">
          <el-table-column
            label="本月数"
            prop="stropmonthtotal"
            width="160"
            align="center"
          ></el-table-column>
          <el-table-column
        ...
        <el-table-column label="广告公司" align="center">
          <el-table-column
            label="本月数"
            prop="stradmonthtotal"
            width="160"
            align="center"
          ></el-table-column>
          <el-table-column
...
import {
  exportAdvertisingIncomeDepApi,
  exportAdvertisingRealIncomeExcelApi
 ...
 */
const getReport = () => {
  exportAdvertisingIncomeDepApi().then((res) => {
    if (res.success) {
      console.log(res.obj)
