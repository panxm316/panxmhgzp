 ...
 * @LastEditTime: 2024-03-15 15:22:04
 * @LastEditors: wanghl
...
<template>
  <div class="app-container">
    <div>
      <div style="width: 100%; margin: -10px 0 10px 5px" v-if="FlowManagerdata === 'add'">
        ...
        >
          ...
          >
            <template #default="scope">
              ...
              <el-button
                v-if="
                  props.bottomshow !== false &&
                  (FlowManagerdata === 'add' || FlowManagerdata === 'change')
                "
                link
                type="primary"
                icon="Edit"
    ...
    >
      ...
      <div
        v-if="
          props.bottomshow !== false && (FlowManagerdata === 'add' || FlowManagerdata === 'change')
        "
...
watch(
  ...
  (newValue, oldValue) => {
    if (newValue) {
      FlowManagerdata.value = newValue
    }
  }
)
onMounted(() => {
  ...
  FlowManagerdata.value = props.FlowManager!
