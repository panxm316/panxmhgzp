 ...
 * @LastEditTime: 2024-03-15 14:47:29
 * @LastEditors: wanghl
    ...
    <div>
      <el-row :span="22">
        ...
        >
          ...
          <el-table-column prop="iapprovestatus" label="审核状态" align="center" width="80">
            <template #default="scope">
        ...
        <el-row style="margin-right: 40px">
          <el-col :span="6">
            <el-form-item prop="prestartdate" label="预刊时间:">
              {{ Worderitem.prestartdate!.substring(0, 10) }}
            </el-form-item>
...
import AdTworderItemBelongdetails from './AdTworderItemBelongdetails.vue'
...
watch(
  ...
  (newValue, oldValue) => {
    if (newValue) {
      ...
      Worderitem.value.ibooktype = newValue!.ibooktype
...
onMounted(() => {
  ...
  Worderitem.value.ibooktype = props.data!.ibooktype
