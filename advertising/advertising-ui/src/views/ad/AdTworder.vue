 ...
 * @LastEditTime: 2024-03-14 17:16:38
 * @LastEditors: wanghl
            ...
            <el-row :gutter="22" style="padding-right: 40px">
              <el-col :span="8">
                ...
                <el-form-item label="广告资源" prop="adresourceapplicationid">
                  <div>
                    ...
                    >
                    <div>
                      <div v-for="(file, index) in TworderData.adresourceapplicationid" :key="file">
              ...
              <el-col :span="8">
                ...
                <el-form-item label="负责人意见" prop="sopinion">
                  <el-input v-model="TworderData.sopinion" :maxlength="200" disabled />
                </el-form-item>
              </el-col>
              <el-col :span="8">
...
import AdTworderItem from './AdTworderItem.vue'
...
watch(
  ...
  (newValue, oldValue) => {
    if (newValue) {
      ...
      HgAdprojectdiv.value.view(newValue.sname as string)
    }
  },
  { deep: true }
)
...
onMounted(() => {
  ...
  if (props.dataadproject !== undefined) {
    ...
    HgAdprojectdiv.value.view(props.dataadproject.sname as string)
  }
  // if (TworderData.value.id === '' && props.resourceid !== 'null') {
  //   TworderData.value.adresourceapplicationid = []
  //   TworderData.value.adresourceapplicationid!.push(props.resourceid!)
  //   Resourceid.value = props.resourceid!
  // }
...
const getorderById = () => {
  getorderByIdApi(WorderId.value).then(({ obj, success, msg }: IAxios) => {
    if (success) {
      HgAdprojectdiv.value.view(obj.adprojectname as string)
