 ...
 * @LastEditTime: 2023-11-16 16:08:21
 * @LastEditors: peij
        ...
        getInfo()
          .then((res: IAxios<ILoginInfoVo>) => {
            if (res.success) {
              ...
              globals.officePreviewUrl = loginInfoVo.officePreviewUrl
              ...
              Cookies.set('Advertising-UserId', user.userid.toString())
            }
